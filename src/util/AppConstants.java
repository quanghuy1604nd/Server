...
public class AppConstants {
    ...
    public static final String WEBHOOK_LOG_ENDPOINT = System.getenv().getOrDefault("WEBHOOK_LOG_ENDPOINT", "http://localhost:8080/api/webhook/log");
    public static final String WEBHOOK_SCOREBOARD_ENDPOINT = System.getenv().getOrDefault("WEBHOOK_SCOREBOARD_ENDPOINT", "http://localhost:8080/api/webhook/scoreboard");
